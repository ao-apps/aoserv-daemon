...
final public class AWStatsManager extends BuilderThread {
    ...
    private AWStatsManager() {
        Profiler.startProfile(Profiler.INSTANTANEOUS, AWStatsManager.class, "<init>()", null);
        Profiler.endProfile(Profiler.INSTANTANEOUS);
    }

    private static final Object rebuildLock=new Object();
    protected void doRebuild() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, AWStatsManager.class, "doRebuild()", null);
        try {
            ...
            synchronized(rebuildLock) {
                ...
                for(HttpdSite site : aoServer.getHttpdSites()) {
                    ...
                    out.print("\"\n"
                            ...
                            //+ "HTMLHeadSection=\"<DIV align='center'><A target='_new' href='http://www.aoindustries.com/'><IMG src='https://secure.aoindustries.com/images/clientarea/accounting/SendInvoices.jpg' border='0' width='452' height='127' alt='Hosted by AO Industries, Inc.'></A><BR>Back to <A target='_top' href='../../../AWStats.ao'>Control Panels</A></DIV>\"\n"
                    ...
                    out.print("#!/bin/bash\n"
                            ...
                            + "export REMOTE_ADDR='65.77.181.131'\n"
                            ...
                            + "export SERVER_ADDR='65.77.211.65'\n"
    ...
    public static void start() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, AWStatsManager.class, "start()", null);
        try {
            if(AOServDaemonConfiguration.isManagerEnabled(AWStatsManager.class) && awstatsManager==null) {
                synchronized(System.out) {
                    if(awstatsManager==null) {
    ...
    public String getProcessTimerDescription() {
        Profiler.startProfile(Profiler.INSTANTANEOUS, AWStatsManager.class, "getProcessTimerDescription()", null);
        try {
    ...
    public long getProcessTimerMaximumTime() {
        Profiler.startProfile(Profiler.INSTANTANEOUS, AWStatsManager.class, "getProcessTimerMaximumTime()", null);
        try {
            return 15L*60*1000;
        } finally {
            Profiler.endProfile(Profiler.INSTANTANEOUS);
