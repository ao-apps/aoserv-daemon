...
public final class PackageManager {
  ...
  public enum PackageName {
    ...
    PHP_8_4("php-8.4"),
    PHP_8_4_BCMATH("php-8.4-bcmath"),
    PHP_8_4_BZ2("php-8.4-bz2"),
    PHP_8_4_CURL("php-8.4-curl"),
    PHP_8_4_DBA("php-8.4-dba"),
    PHP_8_4_GD("php-8.4-gd"),
    PHP_8_4_GMP("php-8.4-gmp"),
    PHP_8_4_INTL("php-8.4-intl"),
    PHP_8_4_MBSTRING("php-8.4-mbstring"),
    PHP_8_4_MYSQL("php-8.4-mysql"),
    PHP_8_4_PGSQL("php-8.4-pgsql"),
    PHP_8_4_SOAP("php-8.4-soap"),
    PHP_8_4_SQLITE3("php-8.4-sqlite3"),
    PHP_8_4_XML("php-8.4-xml"),
    PHP_8_4_ZIP("php-8.4-zip"),
    PHP_8_4_EXT_HTTP("php-8.4-ext-http"),
    PHP_8_4_EXT_IMAGICK("php-8.4-ext-imagick"),
    PHP_8_4_EXT_MEMCACHED("php-8.4-ext-memcached"),
    PHP_8_4_EXT_PSPELL("php-8.4-ext-pspell"),
    PHP_8_4_EXT_RAPHF("php-8.4-ext-raphf"),
    PHP_8_4_EXT_REDIS("php-8.4-ext-redis"),
    PHP_8_5("php-8.5"),
    PHP_8_5_BCMATH("php-8.5-bcmath"),
    PHP_8_5_BZ2("php-8.5-bz2"),
    PHP_8_5_CURL("php-8.5-curl"),
    PHP_8_5_DBA("php-8.5-dba"),
    PHP_8_5_GD("php-8.5-gd"),
    PHP_8_5_GMP("php-8.5-gmp"),
    PHP_8_5_INTL("php-8.5-intl"),
    PHP_8_5_MBSTRING("php-8.5-mbstring"),
    PHP_8_5_MYSQL("php-8.5-mysql"),
    PHP_8_5_PGSQL("php-8.5-pgsql"),
    PHP_8_5_SOAP("php-8.5-soap"),
    PHP_8_5_SQLITE3("php-8.5-sqlite3"),
    PHP_8_5_XML("php-8.5-xml"),
    PHP_8_5_ZIP("php-8.5-zip"),
    PHP_8_5_EXT_HTTP("php-8.5-ext-http"),
    PHP_8_5_EXT_IMAGICK("php-8.5-ext-imagick"),
    PHP_8_5_EXT_MEMCACHED("php-8.5-ext-memcached"),
    PHP_8_5_EXT_PSPELL("php-8.5-ext-pspell"),
    PHP_8_5_EXT_RAPHF("php-8.5-ext-raphf"),
    PHP_8_5_EXT_REDIS("php-8.5-ext-redis"),
