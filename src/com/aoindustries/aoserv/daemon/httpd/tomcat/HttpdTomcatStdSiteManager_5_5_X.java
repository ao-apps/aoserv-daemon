...
class HttpdTomcatStdSiteManager_5_5_X extends HttpdTomcatStdSiteManager<TomcatCommon_5_5_X> {
	...
	HttpdTomcatStdSiteManager_5_5_X(HttpdTomcatStdSite tomcatStdSite) throws SQLException, IOException {
		super(tomcatStdSite);
	}
	...
	protected void buildSiteDirectoryContents(UnixFile siteDirectory) throws IOException, SQLException {
		...
		DaemonFileUtils.ln("../../.."+tomcatDirectory+"/bin/commons-logging-api.jar", siteDir+"/bin/commons-logging-api.jar", uid, gid);
		...
		DaemonFileUtils.lnAll("../../../.."+tomcatDirectory+"/common/i18n/", siteDir+"/common/i18n/", uid, gid);
