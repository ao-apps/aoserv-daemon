...
class TomcatCommon_7_0_X extends TomcatCommon {
	...
	/**
	 * Upgrade from Tomcat 7.0.68 to 7.0.77
	 */
	private static final UpgradeSymlink[] upgradeSymlinks_7_0_77 = {
		...
		new UpgradeSymlink(
			...
			null,
			"../../../opt/apache-tomcat-7.0/lib/mysql-connector-java-5.1.41-bin.jar"
		),
		...
		new UpgradeSymlink(
			...
			null,
			"../../../opt/apache-tomcat-7.0/lib/postgresql-42.0.0.jre6.jar"
		)
	};
	...
	boolean upgradeTomcatDirectory(UnixFile tomcatDirectory, int uid, int gid) throws IOException, SQLException {
		...
		if(osConfig==OperatingSystemConfiguration.CENTOS_5_I686_AND_X86_64) {
			...
			} else if(rpmVersion.equals("7.0.77")) {
