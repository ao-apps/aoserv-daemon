    ...
    protected void buildSiteDirectory(UnixFile siteDirectory, Set<HttpdSite> sitesNeedingRestarted, Set<HttpdSharedTomcat> sharedTomcatsNeedingRestarted) throws IOException, SQLException {
        ...
        try {
            out.print("#!/bin/sh\n"
                    ...
                    + ". /usr/aoserv/etc/php-").print(httpdConfig.getDefaultPhpVersion()).print(".sh\n");
        ...
        FileUtils.copyResource(HttpdTomcatStdSiteManager_3_2_4.class, "test-tomcat.xml", siteDir+"/conf/test-tomcat.xml", uid, gid, 0660);
        ...
        FileUtils.copyResource(HttpdTomcatStdSiteManager_3_2_4.class, "web.dtd-3.2.4", siteDir+"/conf/web.dtd", uid, gid, 0660);
        FileUtils.copyResource(HttpdTomcatStdSiteManager_3_2_4.class, "web.xml-3.2.4", siteDir+"/conf/web.xml", uid, gid, 0660);
        ...
        try {
            FileUtils.copyResource(HttpdTomcatStdSiteManager_3_2_4.class, "cocoon.properties.1", fileOut);
            ...
            try {
                ...
                out.flush();
                FileUtils.copyResource(HttpdTomcatStdSiteManager_3_2_4.class, "cocoon.properties.2", fileOut);
            } finally {
                out.flush();
            }
        } finally {
