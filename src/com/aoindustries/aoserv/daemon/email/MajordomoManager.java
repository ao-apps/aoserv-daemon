...
final public class MajordomoManager extends BuilderThread {
    ...
    private MajordomoManager() {
        Profiler.startProfile(Profiler.INSTANTANEOUS, MajordomoManager.class, "<init>()", null);
        Profiler.endProfile(Profiler.INSTANTANEOUS);
    }

    private static final Object rebuildLock=new Object();
    protected void doRebuild() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, MajordomoManager.class, "doRebuild()", null);
        try {
    ...
    public static void start() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, MajordomoManager.class, "start()", null);
        try {
            if(AOServDaemonConfiguration.isManagerEnabled(MajordomoManager.class) && majordomoManager==null) {
                synchronized(System.out) {
                    if(majordomoManager==null) {
    ...
    public String getProcessTimerDescription() {
        Profiler.startProfile(Profiler.INSTANTANEOUS, MajordomoManager.class, "getProcessTimerDescription()", null);
        try {
