 ...
 * Copyright (C) 2016, 2017, 2018, 2020, 2021, 2022, 2023  AO Industries, Inc.
...
final class TomcatCommon_8_0_X extends TomcatCommon {
  ...
  boolean upgradeTomcatDirectory(String optSlash, PosixFile tomcatDirectory, int uid, int gid) throws IOException, SQLException {
    ...
    if (
      ...
      PackageManager.Rpm rpm = PackageManager.getInstalledPackage(PackageManager.PackageName.APACHE_TOMCAT_8_0);
      if (rpm == null) {
        rpm = PackageManager.getInstalledPackage(PackageManager.PackageName.OLD_APACHE_TOMCAT_8_0);
      }
      if (rpm == null) {
        throw new AssertionError("Package not installed: " + PackageManager.PackageName.APACHE_TOMCAT_8_0
            + " or " + PackageManager.PackageName.OLD_APACHE_TOMCAT_8_0);
      }
