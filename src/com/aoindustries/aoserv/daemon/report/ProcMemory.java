...
final public class ProcMemory {
    ...
    public ProcMemory() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, ProcMemory.class, "<init>()", null);
        try {
            int
                mem_total=0,
                mem_free=0,
    ...
    public static void main(String[] args) {
        Profiler.startProfile(Profiler.UNKNOWN, ProcMemory.class, "main(String[])", null);
        try {
            try {
    ...
    public String toString() {
        Profiler.startProfile(Profiler.FAST, ProcMemory.class, "toString()", null);
        try {
            return
                getClass().getName()
                + "?mem_total="+mem_total
