...
final public class ProcStates {
    ...
    public ProcStates() throws IOException, SQLException {
        Profiler.startProfile(Profiler.UNKNOWN, ProcStates.class, "<init>()", null);
        try {
            int
                total_sleep=0,
                user_sleep=0,
    ...
    public static void main(String[] args) {
        Profiler.startProfile(Profiler.UNKNOWN, ProcStates.class, "main(String[])", null);
        try {
            try {
    ...
    public String toString() {
        Profiler.startProfile(Profiler.FAST, ProcStates.class, "toString()", null);
        try {
            return
                getClass().getName()
