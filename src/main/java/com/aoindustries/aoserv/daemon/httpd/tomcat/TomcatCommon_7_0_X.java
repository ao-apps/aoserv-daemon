 ...
 * Copyright (C) 2013, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2026  AO Industries, Inc.
    ...
    if (
      ...
      if ("7.0.42".equals(rpmVersion)) {
        ...
        if (osConfig == OperatingSystemConfiguration.CENTOS_5_I686_AND_X86_64) {
          ...
          "7.0.77".equals(rpmVersion)
              || "7.0.78".equals(rpmVersion)
              || "7.0.79".equals(rpmVersion)
        ...
        for (UpgradeSymlink upgradeSymlink : upgradeSymlinks) {
          ...
          "7.0.84".equals(rpmVersion)
              || "7.0.85".equals(rpmVersion)
        ...
        for (UpgradeSymlink upgradeSymlink : upgradeSymlinks) {
          ...
          "7.0.91".equals(rpmVersion)
              || "7.0.92".equals(rpmVersion)
