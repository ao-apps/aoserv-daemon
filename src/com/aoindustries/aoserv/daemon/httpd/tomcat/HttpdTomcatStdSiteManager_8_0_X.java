...
/**
 * Manages HttpdTomcatStdSite version 8.0.X configurations.
 *
 * @author  AO Industries, Inc.
 */
class HttpdTomcatStdSiteManager_8_0_X extends HttpdTomcatStdSiteManager<TomcatCommon_8_0_X> {

	HttpdTomcatStdSiteManager_8_0_X(HttpdTomcatStdSite tomcatStdSite) throws SQLException, IOException {
		super(tomcatStdSite);
	}

	/**
	 * Builds a standard install for Tomcat 8.0.X
	 */
	@Override
	protected void buildSiteDirectoryContents(UnixFile siteDirectory) throws IOException, SQLException {
		...
		DaemonFileUtils.ln("../../.."+tomcatDirectory+"/conf/tomcat-users.xsd", siteDir+"/conf/tomcat-users.xsd", uid, gid);
		{
