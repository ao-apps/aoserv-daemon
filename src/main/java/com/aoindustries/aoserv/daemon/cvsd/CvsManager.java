 ...
 * Copyright (C) 2002-2013, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2024, 2025, 2026  AO Industries, Inc.
        ...
        for (CvsRepository cvs : cvsRepositories) {
          ...
          if (!cvsRoot.getStat().exists()) {
            AoservDaemon.suexec(
                ...
                "/usr/bin/cvs -d " + cvsPath + " init",
                0
            );
          }
          // Remove from list
          existing.remove(cvsPath.toString());
        }
