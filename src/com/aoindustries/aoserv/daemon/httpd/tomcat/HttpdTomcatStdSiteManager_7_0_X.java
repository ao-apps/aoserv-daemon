/*
 * Copyright 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020 by AO Industries, Inc.,
...
/**
 * Manages PrivateTomcatSite version 7.0.X configurations.
 *
 * @author  AO Industries, Inc.
 */
class HttpdTomcatStdSiteManager_7_0_X extends HttpdTomcatStdSiteManager<TomcatCommon_7_0_X> {

	HttpdTomcatStdSiteManager_7_0_X(PrivateTomcatSite tomcatStdSite) throws SQLException, IOException {
		super(tomcatStdSite);
	}
	...
	protected void buildSiteDirectoryContents(String optSlash, UnixFile siteDirectory, boolean isUpgrade) throws IOException, SQLException {
		...
		}
		{
			...
			new UnixFile("/opt/apache-tomcat-7.0/conf/tomcat-users.xml").copyTo(tu, false);
			tu.chown(uid, gid).setMode(0660);
		}
		{
			UnixFile wx=new UnixFile(siteDir+"/conf/web.xml");
			new UnixFile("/opt/apache-tomcat-7.0/conf/web.xml").copyTo(wx, false);
